...
//****=============================================================================****//	
		...
		array("name" => __("Home Page Testimonial Setting", 'colorway'),
            "type" => "heading"),
		array("name" => __("Testimonial Section On/Off", 'colorway'),
		"desc" => __("Turn on or off the home page testimonial section as per your requirement.", 'colorway'),
		"id" => "colorway_testimonial_status",
		"std" => "",
		"type" => "radio",
		"options" => $on_off),
